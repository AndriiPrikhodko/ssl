...
AuthorizationPage = function(){
    this.url = "https://www.ssls.com/authorize";
}
...
AuthorizationPage.prototype.emailErrorBox = () => element(by.xpath('// div [@ng-show = "(authForm.email.$dirty '+
                                                                  '|| authForm.$submitted) && authForm.email.$error.required"]'));
AuthorizationPage.prototype.passwordErrorBox = () => element(by.xpath('// div [@ng-show ="(authForm.password.$dirty '+
                                                                  '|| authForm.$submitted) && authForm.password.$error.required"]'));
